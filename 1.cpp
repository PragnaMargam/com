// 1. Design a lexical analyzer for a given language and the lexical analyzer should ignore redundant spaces, tabs, and new lines. It should also ignore comments.  
#include<string.h>
#include<ctype.h>
#include<stdio.h>
